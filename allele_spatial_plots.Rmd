...
if(cross=="Pollen"){
  write.csv(peakData, "Trend_Count_Analysis/for_posthoc_analysis_pollen.csv", row.names=FALSE)
} else {
  write.csv(peakData, "Trend_Count_Analysis/for_posthoc_analysis_ear.csv", row.names=FALSE)
}
```
