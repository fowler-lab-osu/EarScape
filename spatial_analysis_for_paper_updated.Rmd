...
for (i in 1:length(list_alleles)){
  ...
  filenames[[i]][[2]] = list.files(paste0("/Users/michellebang/st research lab/spatialanalysis/SpatialAnalysisMichelle/SpatialAnalysis_Alleles_AmbigAdjust/", list_alleles[[i]]), pattern="*.xml", full.names=TRUE) 
