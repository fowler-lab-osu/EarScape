...
```{r}
#Create mega dataframe to contain information for all alleles.
megaDf = data.frame()
...
sequence2  = seq(1, binNumber-2)  #assuming chopped ends
...
#lapply(sq_glm_data_ends, function(x) {print(summary(x))})
...
for (i in 1:length(bin_ed)){
  ...
  #print(anova(null_ends_model[[i]], sq_glm_data_ends[[i]], test = "F"))
  #print(summary(anova(null_ends_model[[i]], sq_glm_data_ends[[i]], test = "F")))
}
